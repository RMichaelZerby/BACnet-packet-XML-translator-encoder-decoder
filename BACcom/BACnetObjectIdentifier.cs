...
namespace BACcom
{
    class BACnetObjectIdentifier : BACVnetVar
    {
        ...
        {
            return "<ObjectId> " + "<ObjectrType>" + ObjectTypeToString() + "</ObjectrType> " + "<InstanceNumber>" + instanceNumber.ToString() + "</InstanceNumber> </ObjectId>";
        }
